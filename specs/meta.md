# CAD UI/UX Meta-Architecture & Interaction Design

> **Scope**: This document outlines the fundamental meta-questions and architectural decisions for CAD UI/UX design that must be answered *before* building the design system or the `IUiBridge` layer. It serves as the interaction blueprint for the miki engine.
> **Context**: Evaluated against 2026 industry standards, spatial computing trends, and cognitive science principles.
...
| **Industry Examples**| Shapr3D, Plasticity, miki (`DrillMenu`/`PieMenu`) | SolidWorks, CATIA V5, NX |

**2026 Design Conclusion: Hybrid Grammar (Noun-Verb Dominant)**
...
## 2. Locus of Attention: In-Canvas vs. Out-of-Canvas
...
**2026 Design Conclusion: Maximize In-Canvas Operations**
...
## 3. State Management: Modal vs. Modeless
...
**2026 Design Conclusion: Soft-Modal via Visual Metaphors**
...
## 4. Intent Capture: Explicit Declaration vs. Predictive Inferencing
...
**2026 Design Conclusion: AI-Assisted Predictive UI**
...
## 5. Topological Mutability: History-based vs. Direct Modeling
...
**2026 Design Conclusion: Implicitly Parameterized Direct Modeling**
...
**2026 Design Conclusion: Progressive Disclosure & Semantic Coloring**
...
**2026 Design Conclusion: Volumetric & Multi-Modal Ready**
