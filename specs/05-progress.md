...
> **Spec reference**: `specs/05-shader-pipeline.md`
> **Status**: Phases 1a through 5+ **complete**. Phase 17+ (Neural) **complete** (inference path). Phase 15a+ (Metal) and VK_EXT_shader_object evaluation **pending**.
...
### 5.1 Shader CMake (`shaders/CMakeLists.txt`)
...
- `DEPENDS` tracks all implementing files for correct incremental rebuild

### 5.2 Test CMake (`cmake/targets/tests.cmake`)
