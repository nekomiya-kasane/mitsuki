...
| E-2  | `RenderGraphExecutor::AllocateTransients` — heap pool + placed resource creation                 | §6.1         | **DONE**    | Per-group heap creation, `AliasTextureMemory` binding, imported resource passthrough, texture view creation. Cross-frame HeapPool reuse deferred to Phase F-1.                                                       |
